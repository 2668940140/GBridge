...
const BottomBar = ({ navigation, selected }) => {
  return (
    <View style={styles.buttonContainer}>
      ...
      <MarketButton onPress={() => resetNavigator(navigation, 'PersonalPage')} selected={selected === 'PersonalPage'} />
      <ProfileButton onPress={() => resetNavigator(navigation, 'PersonalInfo')} selected={selected === 'PersonalInfo'} />
      <ScoreButton onPress={() => resetNavigator(navigation, 'Score')} selected={selected === 'Score'} />
    </View>
  );
}
...
export {
  MyButton, TwoButtonsInline, SingleButton, LogoutButton, BottomBar,
